    ...
    $.fn.tweet = function(o){
        ...
        function relative_time(time_value) {
            ...
            if (delta < 60) {
                ...
                r = '' + (parseInt(delta / 3600, 10)).toString() + ' hs.';
        ...
        return this.each(function(i, widget){
            ...
            $(widget).bind("load", function(){
                    ...
                    $.each(tweets, function(i,item){
                        ...
                        var usernamefull = item.user.name;
                        ...
                        var name = '<span class="tweet_name"><a target="_blank" href="http://'+s.twitter_url+'/'+from_user+'/statuses/'+item.id_str+'" title="view tweet on twitter">'+usernamefull+'</a></span> ';
                        var date = '<span class="tweet_time"><a target="_blank" href="http://'+s.twitter_url+'/'+from_user+'/statuses/'+item.id_str+'" title="view tweet on twitter">'+relative_time(item.created_at)+'</a></span><br>';
                        //var sep = '<div class="CleanFloats"></div>';
                        var text = '<span class="tweet_text">' +$([item.text]).linkUrl().linkUser().linkHash().makeHeart().capAwesome().capEpic()[0]+ '</span>';
   
                        // until we create a template option, arrange the items below to alter a tweet's display.
                        list.append('<li>' + avatar + name + date + join + text + '</li>');
